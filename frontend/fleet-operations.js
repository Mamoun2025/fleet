...
function initializeEvents() {
    ...
    if (addBtn) {
        console.log('Bouton NOUVEAU trouvé, ajout du gestionnaire d\'événement');
        addBtn.addEventListener("click", function(e) {
            e.preventDefault();
            console.log('Bouton NOUVEAU cliqué');
            if (typeof window.addNewVehicle === 'function') {
                window.addNewVehicle();
            } else {
                console.error('La fonction addNewVehicle n\'est pas disponible');
                alert('Erreur: La fonction d\'ajout n\'est pas disponible.');
            }
        });
    } else {
    ...
    if (deleteSelectedButton) {
        console.log('Bouton SUPPRIMER trouvé, ajout du gestionnaire d\'événement');
        deleteSelectedButton.addEventListener("click", function(e) {
            ...
            if (typeof window.deleteSelectedRows === 'function') {
                ...
                console.error('La fonction deleteSelectedRows n\'est pas disponible');
                alert('Erreur: La fonction de suppression n\'est pas disponible.');
            }
        });
    } else {
